package com.example.moetaz.bakingapp.provider;
...
import com.example.moetaz.bakingapp.datastorage.DBAdadpter;
...
public class IngProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.moetaz.bakingapp";

    public static final String PATH_ING_LIST = "ING_LIST";
    public static final int Ing_LIST = 1;
    ...
    static {
        ...
        MATCHER.addURI(AUTHORITY, PATH_ING_LIST, Ing_LIST);
     }
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
        ...
        switch (MATCHER.match(uri)){
            case Ing_LIST:  cursor = dbAdadpter.getCursorsForAllData(); break;
    ...
    public String getType(@NonNull Uri uri) {
        switch (MATCHER.match(uri)){
            case Ing_LIST:return MIME_TYPE_1;
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) throws UnsupportedOperationException{
        ...
        switch (MATCHER.match(uri)){
            ...
            case Ing_LIST: Returnuri = insertIng(uri,values);break;
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) throws UnsupportedOperationException {
        ...
        switch (MATCHER.match(uri)){
            ...
            case Ing_LIST: deleteCount = delete();break;
            default: new UnsupportedOperationException("Error") ;break;
        }
        return deleteCount;
    }
